...
export function resolveTokenKinds(syntaxKind: SyntaxKindEnum): TokenKinds {
  ...
  return {
    ...
    ColonToken: at('ColonToken'),
    CommaToken: at('CommaToken'),
    ExclamationToken: at('ExclamationToken'),
    ClassKeyword: at('ClassKeyword'),
    InterfaceKeyword: at('InterfaceKeyword'),
    EnumKeyword: at('EnumKeyword'),
    NamespaceKeyword: at('NamespaceKeyword'),
    ModuleKeyword: at('ModuleKeyword'),
    TypeKeyword: at('TypeKeyword'),
